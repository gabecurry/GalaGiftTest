...
Here's a revised version of the backstory with added details and no mention of Christmas:
...
const suspects = [
  {
    ...
    backstory: "Known for her extravagant lifestyle, Holly has recently faced financial difficulties. She was seen lingering near the gifts for too long, perhaps plotting her move?",
    clues: [
  ...
  {
    name: "Nicholas Claus",
    backstory: "Dressed as Frosty, Nicholas charmed the guests, but no one recalls inviting him. Was his happy demeanor just a clever disguise for a cunning thief?",
    clues: [
  ...
  {
    name: "Eve Garland",
    backstory: "The event planner and Frostworth family cousin, Eve’s career was riding on the gala’s success. Under immense pressure, did she resort to desperate measures?",
    clues: [
  ...
  {
    name: "Ivy Garland",
    backstory: "Eve’s younger cousin, Ivy, is notorious for pulling holiday pranks. Could this heist have been her attempt at creating the ultimate gala chaos?",
    clues: [
